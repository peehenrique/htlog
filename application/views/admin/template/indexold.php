      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('admin/produtos'); ?>"><i class="fa fa-th"></i> <span>Produtos</span></a></li>
            <li><a href="<?php echo base_url('admin/categorias'); ?>"><i class="fa fa-th"></i> <span>Categorias</span></a></li>
            <li><a href="<?php echo base_url('admin/marcas'); ?>"><i class="fa fa-th"></i> <span>Marcas</span></a></li>
          </ul>
        </li>
...
<!-- SlimScroll -->
<script src="<?php echo base_url('/public/js/jquery-slimscroll/jquery.slimscroll.min.js'); ?>"></script>
<!-- FastClick -->
<script src="<?php echo base_url('/public/js/fastclick/lib/fastclick.js'); ?>"></script>
<!-- Data Tables -->
<script src="<?php echo base_url('/public/dist/data-tables/datatables.js'); ?>"></script>
<!-- AdminLTE App -->
